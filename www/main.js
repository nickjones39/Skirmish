(() => {
  ...
  var Zs = (i, r, o) => r in i ? Kt(i, r, { enumerable: true, configurable: true, writable: true, value: o }) : i[r] = o;
  var l = (i, r) => Kt(i, "name", { value: r, configurable: true });
  var eo = (i, r) => {
    for (var o in r)
      Kt(i, o, { get: r[o], enumerable: true });
  };
  var he = (i, r, o) => (Zs(i, typeof r != "symbol" ? r + "" : r, o), o);
  var to = (() => {
  ...
  l(Je, "rad2deg");
  function De(i, r, o) {
    return r > o ? De(i, o, r) : Math.min(Math.max(i, r), o);
  }
  l(De, "clamp");
  function Se(i, r, o) {
  ...
  var ee = class {
    ...
    b = 255;
    constructor(r, o, u) {
      this.r = De(r, 0, 255), this.g = De(o, 0, 255), this.b = De(u, 0, 255);
    }
    static fromArray(r) {
  ...
  var M = ee;
  l(M, "Color"), he(M, "RED", new ee(255, 0, 0)), he(M, "GREEN", new ee(0, 255, 0)), he(M, "BLUE", new ee(0, 0, 255)), he(M, "YELLOW", new ee(255, 255, 0)), he(M, "MAGENTA", new ee(255, 0, 255)), he(M, "CYAN", new ee(0, 255, 255)), he(M, "WHITE", new ee(255, 255, 255)), he(M, "BLACK", new ee(0, 0, 0));
  function j(...i) {
    if (i.length === 0)
      return new M(255, 255, 255);
    if (i.length === 1) {
      if (i[0] instanceof M)
        return i[0].clone();
      if (typeof i[0] == "string")
        return M.fromHex(i[0]);
      if (Array.isArray(i[0]) && i[0].length === 3)
        return M.fromArray(i[0]);
    }
    return new M(...i);
  }
  l(j, "rgb");
  var Zn = l((i, r, o) => M.fromHSL(i, r, o), "hsl2rgb");
  var X = class {
    x = 0;
    y = 0;
    w = 1;
  ...
  var Y = class {
    ...
    invert() {
      ...
      let Mt = this.m[0] * r[0] + this.m[1] * r[4] + this.m[2] * r[8] + this.m[3] * r[12];
  ...
  var Ke = class {
    ...
    gen() {
      return this.seed = (no * this.seed + ro) % Wn, this.seed / Wn;
    }
    genNumber(r, o) {
    ...
    genColor(r, o) {
      return new M(this.genNumber(r.r, o.r), this.genNumber(r.g, o.g), this.genNumber(r.b, o.b));
    }
    genAny(...r) {
      if (r.length === 0)
        return this.gen();
      if (r.length === 1) {
        ...
        if (r[0] instanceof M && r[1] instanceof M)
  ...
  l(Me, "Timer");
  var on = { "Joy-Con L+R (STANDARD GAMEPAD Vendor: 057e Product: 200e)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "6": "ltrigger", "7": "rtrigger", "8": "select", "9": "start", "10": "lstick", "11": "rstick", "12": "dpad-up", "13": "dpad-down", "14": "dpad-left", "15": "dpad-right", "16": "home", "17": "capture" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 3 } } }, "Joy-Con (L) (STANDARD GAMEPAD Vendor: 057e Product: 2006)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "9": "select", "10": "lstick", "16": "start" }, sticks: { left: { x: 0, y: 1 } } }, "Joy-Con (R) (STANDARD GAMEPAD Vendor: 057e Product: 2007)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "9": "start", "10": "lstick", "16": "select" }, sticks: { left: { x: 0, y: 1 } } }, "Pro Controller (STANDARD GAMEPAD Vendor: 057e Product: 2009)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "6": "ltrigger", "7": "rtrigger", "8": "select", "9": "start", "10": "lstick", "11": "rstick", "12": "dpad-up", "13": "dpad-down", "14": "dpad-left", "15": "dpad-right", "16": "home", "17": "capture" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 3 } } }, "Xbox 360 Controller (STANDARD GAMEPAD Vendor: 045e Product: 028e)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "6": "ltrigger", "7": "rtrigger", "8": "select", "9": "start", "10": "lstick", "11": "rstick", "12": "dpad-up", "13": "dpad-down", "14": "dpad-left", "15": "dpad-right", "16": "home" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 3 } } }, default: { buttons: { "0": "north", "1": "east", "2": "south", "3": "west", "4": "ltrigger", "5": "rtrigger", "6": "lshoulder", "7": "rshoulder", "8": "select", "9": "start", "10": "lstick", "11": "rstick" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 5 } } } };
  ...
  var fo = "3000.0.0-alpha.25";
  var vr = { ArrowLeft: "left", ArrowRight: "right", ArrowUp: "up", ArrowDown: "down", " ": "space" };
  var mo = /* @__PURE__ */ new Set([" ", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Tab"]);
  ...
  var Rr = "nearest";
  var vo = 1;
  var Mr = [{ name: "a_pos", size: 2 }, { name: "a_uv", size: 2 }, { name: "a_color", size: 4 }];
  var Dt = Mr.reduce((i, r) => i + r.size, 0);
  var Br = 2048;
  var Pr = Br * 4 * Dt;
  var Dr = Br * 6;
  var bo = `
...
`;
  var Uo = /* @__PURE__ */ new Set(["id", "require"]);
  var xo = /* @__PURE__ */ new Set(["add", "update", "draw", "destroy", "inspect", "drawInspect"]);
  function Eo(i) {
    i.requestFullscreen ? i.requestFullscreen() : i.webkitRequestFullscreen && i.webkitRequestFullscreen();
  }
  l(Eo, "enterFullscreen");
  function Co() {
  ...
  var ta = l((i = {}) => {
    ...
    let g = (() => {
      ...
      i.background && (a = M.fromArray(i.background), c = i.background[3] ?? 1, u.clearColor(a.r / 255, a.g / 255, a.b / 255, c)), u.enable(u.BLEND), u.enable(u.SCISSOR_TEST), u.blendFuncSeparate(u.SRC_ALPHA, u.ONE_MINUS_SRC_ALPHA, u.ONE, u.ONE_MINUS_SRC_ALPHA);
      let s = u.createBuffer();
      u.bindBuffer(u.ARRAY_BUFFER, s), u.bufferData(u.ARRAY_BUFFER, Pr * 4, u.DYNAMIC_DRAW), Mr.reduce((d, p, b) => (u.vertexAttribPointer(b, p.size, u.FLOAT, false, Dt * 4, d), u.enableVertexAttribArray(b), d + p.size * 4), 0), u.bindBuffer(u.ARRAY_BUFFER, null);
      let h = u.createBuffer();
      u.bindBuffer(u.ELEMENT_ARRAY_BUFFER, h), u.bufferData(u.ELEMENT_ARRAY_BUFFER, Dr * 4, u.DYNAMIC_DRAW), u.bindBuffer(u.ELEMENT_ARRAY_BUFFER, null);
    ...
    class _ {
      ...
      static fromURL(t) {
        return sn(t) ? _.fromArrayBuffer(hr(t)) : Mt(t).then((n) => _.fromArrayBuffer(n));
      }
    }
    l(_, "SoundData");
    let F = (() => {
    ...
    function Bt(e = un, t = cn) {
      let n = bo.replace("{{user}}", e ?? un), a = yo.replace("{{user}}", t ?? cn), c = u.createShader(u.VERTEX_SHADER), s = u.createShader(u.FRAGMENT_SHADER);
      ...
      if (r.push(() => u.deleteProgram(h)), u.attachShader(h, c), u.attachShader(h, s), u.bindAttribLocation(h, 0, "a_pos"), u.bindAttribLocation(h, 1, "a_uv"), u.bindAttribLocation(h, 2, "a_color"), u.linkProgram(h), !u.getProgramParameter(h, u.LINK_STATUS)) {
        let m = l((T) => {
          let H = /^ERROR:\s0:(?<line>\d+):\s(?<msg>.+)/, D = T.match(H);
          return { line: Number(D.groups.line), msg: D.groups.msg.replace(/\n\0$/, "") };
      ...
      return u.deleteShader(c), u.deleteShader(s), { bind() {
        ...
        for (let d in m) {
          ...
          typeof p == "number" ? u.uniform1f(b, p) : p instanceof Y ? u.uniformMatrix4fv(b, false, new Float32Array(p.m)) : p instanceof M ? u.uniform3f(b, p.r, p.g, p.b) : p instanceof v && u.uniform2f(b, p.x, p.y);
        }
      } };
    }
    l(Bt, "makeShader");
    ...
    function Ft(e, t, n, a = g.defTex, c = g.defShader, s = {}) {
      ...
      if (!h || h instanceof k)
        return;
      (a !== g.curTex || h !== g.curShader || !tn(g.curUniform, s) || g.vqueue.length + e.length * Dt > Pr || g.iqueue.length + t.length > Dr) && Ee();
      ...
      for (let d of t)
        g.iqueue.push(d + g.vqueue.length / Dt - e.length);
    ...
    function qe(e) {
      ...
      if (e.width <= 0 || e.height <= 0)
        return;
      let t = e.width, n = e.height, c = Ze(e.anchor || Rt).scale(new v(t, n).scale(-0.5)), s = e.quad || new X(0, 0, 1, 1), h = e.color || j(255, 255, 255), m = e.opacity ?? 1, d = e.tex ? Or / e.tex.width : 0, p = e.tex ? Or / e.tex.height : 0, b = s.x + d, T = s.y + p, H = s.w - d * 2, D = s.h - p * 2;
      fe(), W(e.pos), He(e.angle), ke(e.scale), W(c), Ft([{ pos: new v(-t / 2, n / 2), uv: new v(e.flipX ? b + H : b, e.flipY ? T : T + D), color: h, opacity: m }, { pos: new v(-t / 2, -n / 2), uv: new v(e.flipX ? b + H : b, e.flipY ? T + D : T), color: h, opacity: m }, { pos: new v(t / 2, -n / 2), uv: new v(e.flipX ? b : b + H, e.flipY ? T + D : T), color: h, opacity: m }, { pos: new v(t / 2, n / 2), uv: new v(e.flipX ? b : b + H, e.flipY ? T : T + D), color: h, opacity: m }], [0, 1, 3, 1, 2, 3], e.fixed, e.tex, e.shader, e.uniform), ue();
    }
    l(qe, "drawUVQuad");
    function ft(e) {
      if (!e.tex)
    ...
    function nt(e) {
      ...
      let a = e.width || 1, c = n.sub(t).unit().normal().scale(a * 0.5), s = [t.sub(c), t.add(c), n.add(c), n.sub(c)].map((h) => ({ pos: new v(h.x, h.y), uv: new v(0), color: e.color ?? M.WHITE, opacity: e.opacity ?? 1 }));
    ...
    function Fe(e) {
      ...
      if (!(t < 3)) {
        if (fe(), W(e.pos), ke(e.scale), He(e.angle), W(e.offset), e.fill !== false) {
          let n = e.color ?? M.WHITE, a = e.pts.map((s, h) => ({ pos: new v(s.x, s.y), uv: new v(0, 0), color: e.colors ? e.colors[h] ?? n : n, opacity: e.opacity ?? 1 })), c = [...Array(t - 2).keys()].map((s) => [0, s + 1, s + 2]).flat();
    ...
    function Le(e) {
      ...
      let s = e.size || t.size, h = U(e.scale ?? 1).scale(s / t.size), m = e.lineSpacing ?? 0, d = e.letterSpacing ?? 0, p = 0, b = 0, T = 0, H = [], D = [], I = 0, E = null, x = null;
      for (; I < c.length; ) {
        let G = c[I];
        if (G === `
`)
          T += s + m, H.push({ width: p - d, chars: D }), E = null, x = null, p = 0, D = [];
        else {
          let V = t.map[G];
          if (V) {
            let R = V.w * h.x;
            e.width && p + R > e.width && (T += s + m, E != null && (I -= D.length - E, G = c[I], V = t.map[G], R = V.w * h.x, D = D.slice(0, E - 1), p = x), E = null, x = null, H.push({ width: p - d, chars: D }), p = 0, D = []), D.push({ tex: t.tex, width: V.w, height: V.h, quad: new X(V.x / t.tex.width, V.y / t.tex.height, V.w / t.tex.width, V.h / t.tex.height), ch: G, pos: new v(p, T), opacity: e.opacity ?? 1, color: e.color ?? M.WHITE, scale: U(h), angle: 0 }), G === " " && (E = D.length, x = p), p += R, b = Math.max(b, p), p += d;
          }
        }
        I++;
      }
      H.push({ width: p - d, chars: D }), T += s, e.width && (b = e.width);
      let J = [];
      for (let G of H) {
        let V = (b - G.width) * To(e.align ?? "left");
    ...
    l(Gt, "setMousePos"), se.mousemove = (e) => {
      ...
      mo.has(e.key) && e.preventDefault(), f.ev.onOnce("input", () => {
    ...
    let z = { inspect: false, timeScale: 1, showLog: true, fps: () => o.fpsCounter.fps, numFrames: () => o.numFrames, stepFrame: Xn, drawCalls: () => g.drawCalls, clearLog: () => f.logs = [], log: (e) => {
      let t = i.logMax ?? vo, n = e instanceof Error ? "error" : "info";
    ...
    function Ln(e) {
      let t = /* @__PURE__ */ new Map(), n = {}, a = new ye(), c = { id: mr(), hidden: false, paused: false, transform: new Y(), children: [], parent: null, add(s) {
        ...
        for (let d in s) {
          ...
          if (typeof p.value == "function" && (s[d] = s[d].bind(this)), p.set && Object.defineProperty(s, d, { set: p.set.bind(this) }), p.get && Object.defineProperty(s, d, { get: p.get.bind(this) }), xo.has(d))
    ...
    function In() {
      Pe("f1", () => {
        ...
        z.timeScale = st(De(z.timeScale - 0.2, 0, 2), 1);
      }), Pe("f9", () => {
        z.timeScale = st(De(z.timeScale + 0.2, 0, 2), 1);
      }), Pe("f10", () => {
        z.stepFrame();
    ...
    function us(e = {}) {
      ...
      return { id: "area", collisionIgnore: e.collisionIgnore ?? [], add() {
        this.area.cursor && t.push(this.onHover(() => Dn(this.area.cursor))), t.push(this.onCollideUpdate((c, s) => {
    ...
    function Ht(e, t = {}) {
      ...
      return { id: "sprite", width: 0, height: 0, frame: t.frame || 0, quad: t.quad || new X(0, 0, 1, 1), animSpeed: t.animSpeed ?? 1, flipX: t.flipX ?? false, flipY: t.flipY ?? false, draw() {
        ...
        if (n.slice9) {
          let { left: m, right: d, top: p, bottom: b } = n.slice9, T = n.tex.width * h.w, H = n.tex.height * h.h, D = this.width - m - d, I = this.height - p - b, E = m / T, x = d / T, J = 1 - E - x, G = p / H, V = b / H, R = 1 - G - V, le = [te(0, 0, E, G), te(E, 0, J, G), te(E + J, 0, x, G), te(0, G, E, R), te(E, G, J, R), te(E + J, G, x, R), te(0, G + R, E, V), te(E, G + R, J, V), te(E + J, G + R, x, V), te(0, 0, m, p), te(m, 0, D, p), te(m + D, 0, d, p), te(0, p, m, I), te(m, p, D, I), te(m + D, p, d, I), te(0, p + I, m, b), te(m, p + I, D, b), te(m + D, p + I, d, b)];
          for (let w = 0; w < 9; w++) {
            let S = le[w], C = le[w + 9];
    ...
    function cs(e, t = {}) {
      ...
      return l(n, "update"), { id: "text", text: e, textSize: t.size ?? go2, font: t.font, width: t.width, height: 0, align: t.align, lineSpacing: t.lineSpacing, letterSpacing: t.letterSpacing, textTransform: t.transform, textStyles: t.styles, add() {
        kn(() => n(this));
      }, draw() {
        Ge(n(this));
      }, renderArea() {
    ...
    l(ds, "circle");
    function fs(e = 1, t = j(0, 0, 0)) {
      return { id: "outline", outline: { width: e, color: t } };
    }
    l(fs, "outline");
    function Nn(e, t) {
      let n = new je();
      return e && t && n.pushd(new Me(e, t)), { id: "timer", wait(a, c) {
        let s = [c], h = new Me(a, () => s.forEach((d) => d())), m = n.pushd(h);
        return { get paused() {
          return h.paused;
        }, set paused(d) {
          h.paused = d;
    ...
    function gs(e = {}) {
      ...
      return { id: "body", require: ["pos", "area"], jumpForce: e.jumpForce ?? ms, gravityScale: e.gravityScale ?? 1, isStatic: e.isStatic ?? false, mass: e.mass ?? 1, add() {
        ...
        let h = t.y;
        t.y += f.gravity * this.gravityScale * me(), t.y = Math.min(t.y, e.maxVelocity ?? ps), h < 0 && t.y >= 0 && this.trigger("fall"), this.move(t);
      }, destroy() {
    ...
    function Os(e, t) {
      ...
      let n = ot([bt(t.pos ?? U(0))]), a = e.length, c = 0, s = null, h = null, m = null, d = null, p = l((w) => w.x + w.y * c, "tile2Hash"), b = l((w) => U(Math.floor(w % c), Math.floor(w / c)), "hash2Tile"), T = l(() => {
        ...
        for (let S of n.children) {
          ...
          (S.tilePos.x != C.x || S.tilePos.y != C.y) && (w = true, D(S), S.tilePos.x = C.x, S.tilePos.y = C.y, H(S));
        }
    ...
    l(Ms, "destroy");
    let ot = f.root.add.bind(f.root), Bs = f.root.readd.bind(f.root), Fs = f.root.removeAll.bind(f.root), zn = f.root.get.bind(f.root);
    function Yn(e = 2, t = 1) {
      let n = 0;
    ...
    l(Yn, "boom");
    let Ls = et(null, gr), Gs = et(null, wr);
    function Vs(e, t = {}) {
      let n = ot([bt(e), _n()]), a = (t.speed || 1) * 5, c = t.scale || 1;
      n.add([Ht(Gs), yt(0), kt("center"), Yn(a, c), ...t.comps ?? []]);
      let s = n.add([Ht(Ls), yt(0), kt("center"), Nn(0.4 / a, () => s.use(Yn(a, c))), ...t.comps ?? []]);
    ...
    l(Is, "processGamepad");
    function js() {
      f.ev.trigger("input"), o.keyState.down.forEach((e) => f.ev.trigger("keyDown", e)), o.mouseState.down.forEach((e) => f.ev.trigger("mouseDown", e)), o.virtualButtonState.down.forEach((e) => f.ev.trigger("virtualButtonDown", e)), Is();
    }
    l(js, "inputFrame");
    function Xn() {
      f.root.update();
    ...
    l(xt, "Collision");
    function Ns() {
      let e = {}, t = i.hashGridSize || wo, n = new Y(), a = [];
      function c(s) {
        if (a.push(n.clone()), s.pos && n.translate(s.pos), s.scale && n.scale(s.scale), s.angle && n.rotate(s.angle), s.transform = n.clone(), s.c("area") && !s.paused) {
          let h = s, d = h.worldArea().bbox(), p = Math.floor(d.pos.x / t), b = Math.floor(d.pos.y / t), T = Math.ceil((d.pos.x + d.width) / t), H = Math.ceil((d.pos.y + d.height) / t), D = /* @__PURE__ */ new Set();
          for (let I = p; I <= T; I++)
            for (let E = b; E <= H; E++)
              if (!e[I])
                e[I] = {}, e[I][E] = [h];
...
`), font: Pt, pos: U(e, -e), anchor: "botleft", size: 16, width: ne() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: j(127, 127, 127) }, info: { color: j(255, 255, 255) }, error: { color: j(255, 0, 127) } } });
    ...
    l(qs, "drawVirtualControls"), i.debug !== false && In(), i.burp && jn();
    function $s(e) {
      f.ev.on("loading", e);
    }
    l($s, "onLoading");
    ...
    l(Ys, "onGamepadConnect");
    function Xs(e) {
      f.ev.on("gamepadDisconnect", e);
    }
    l(Xs, "onGamepadDisconnect");
    function Ks(e) {
      f.ev.on("error", e);
    }
    l(Ks, "onError");
    ...
    function Jn(e) {
      ...
      let t = l((n) => {
        ...
        o.realTime = a, o.skipTime || (o.dt = c, o.time += me(), o.fpsCounter.tick(o.dt)), o.skipTime = false, o.numFrames++, zr(), e(), Xr(), Js(), f.ev.trigger("frameEnd"), o.loopID = requestAnimationFrame(t);
      }, "frame");
      t(0);
    }
    l(Jn, "run");
    ...
    let Et = true;
    Jn(() => {
      P.loaded || we() === 1 && !Et && (P.loaded = true, f.ev.trigger("load")), !P.loaded && i.loadingScreen !== false || Et ? ks() : (js(), z.paused || Xn(), Ns(), _s(), i.debug !== false && Hs(), i.virtualControls && Bn() && qs()), Et && (Et = false);
    }), Rn();
    let Ye = { VERSION: fo, loadRoot: ht, loadProgress: we, loadSprite: et, loadSpriteAtlas: hn, loadSound: Nr, loadBitmapFont: Lr, loadFont: Fr, loadShader: Ir, loadShaderURL: jr, loadAseprite: Vr, loadPedit: Gr, loadBean: _r, load: ie, getSprite: fn, getSound: mn, getFont: pn, getBitmapFont: gn, getShader: wn, Asset: k, SpriteData: B, SoundData: _, width: ne, height: Q, center: Ut, dt: me, time: It, screenshot: pi, record: Ps, isFocused: Ds, setCursor: Dn, getCursor: gi, setFullscreen: wi, isFullscreen: Mn, isTouchScreen: Bn, onLoad: kn, onLoading: $s, onResize: zs, onGamepadConnect: Ys, onGamepadDisconnect: Xs, onError: Ks, camPos: vi, camScale: bi, camRot: yi, shake: Ui, toScreen: jt, toWorld: Fn, setGravity: Ki, getGravity: Ji, setBackground: Wi, getBackground: Qi, getGamepads: Zi, add: ot, destroy: Ms, destroyAll: Fs, get: zn, readd: Bs, pos: bt, scale: yt, rotate: es, color: ts, opacity: ns, anchor: kt, area: us, sprite: Ht, text: cs, rect: ls, circle: ds, uvquad: hs, outline: fs, body: gs, doubleJump: ws, shader: vs, timer: Nn, fixed: bs, stay: _n, health: ys, lifespan: Us, z: rs, move: ss, offscreen: as, follow: is, state: xs, fadeIn: Es, tile: $n, agent: Rs, on: Re, onUpdate: Nt, onDraw: xi, onAdd: _t, onDestroy: Gn, onClick: Ti, onCollide: Ei, onCollideUpdate: Ci, onCollideEnd: Si, onHover: Ai, onHoverUpdate: Oi, onHoverEnd: Ri, onKeyDown: Di, onKeyPress: Pe, onKeyPressRepeat: Mi, onKeyRelease: Bi, onMouseDown: Fi, onMousePress: Vn, onMouseRelease: Li, onMouseMove: Gi, onCharInput: Vi, onTouchStart: Ii, onTouchMove: ji, onTouchEnd: Ni, onScroll: _i, onVirtualButtonPress: Hi, onVirtualButtonDown: ki, onVirtualButtonRelease: qi, onGamepadButtonDown: $i, onGamepadButtonPress: zi, onGamepadButtonRelease: Yi, onGamepadStick: Xi, mousePos: $e, mouseDeltaPos: Pn, isKeyDown: oi, isKeyPressed: ii, isKeyPressedRepeat: si, isKeyReleased: ai, isMouseDown: ni, isMousePressed: pt, isMouseReleased: Vt, isMouseMoved: ri, isVirtualButtonPressed: ui, isVirtualButtonDown: ci, isVirtualButtonReleased: li, isGamepadButtonPressed: hi, isGamepadButtonDown: di, isGamepadButtonReleased: fi, charInputted: mi, loop: Pi, wait: vt, play: yn, volume: qr, burp: Un, audioCtx: F.ctx, Timer: Me, Line: de, Rect: K, Circle: Te, Polygon: ge, Vec2: v, Color: M, Mat4: Y, Quad: X, RNG: Ke, rand: ut, randi: Qt, randSeed: er, vec2: U, rgb: j, hsl2rgb: Zn, quad: te, choose: nr, chance: tr, lerp: Se, tween: $t, easings: ct, map: Ct, mapc: Qn, wave: Wt, deg2rad: be, rad2deg: Je, testLineLine: Xe, testRectRect: rr, testRectLine: ir, testRectPoint: We, testCirclePolygon: or, testLinePoint: sr, testLineCircle: Zt, drawSprite: Wr, drawText: mt, formatText: Le, drawRect: ce, drawLine: nt, drawLines: xn, drawTriangle: En, drawCircle: Be, drawEllipse: Cn, drawUVQuad: qe, drawPolygon: Fe, drawFormattedText: Ge, drawMasked: Qr, drawSubtracted: Zr, pushTransform: fe, popTransform: ue, pushTranslate: W, pushScale: ke, pushRotate: He, pushMatrix: Jr, usePostEffect: Yr, debug: z, scene: Cs, go: Ss, addLevel: Os, getData: Ts, setData: Hn, download: Ot, downloadJSON: dr, downloadText: nn, downloadBlob: rn, plug: qn, ASCII_CHARS: yr, canvas: o.canvas, addKaboom: Vs, LEFT: v.LEFT, RIGHT: v.RIGHT, UP: v.UP, DOWN: v.DOWN, RED: M.RED, GREEN: M.GREEN, BLUE: M.BLUE, YELLOW: M.YELLOW, MAGENTA: M.MAGENTA, CYAN: M.CYAN, WHITE: M.WHITE, BLACK: M.BLACK, quit: Ws, Event: ae, EventHandler: ye, EventController: pe };
